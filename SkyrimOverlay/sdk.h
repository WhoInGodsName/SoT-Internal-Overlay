...
struct AAthenaCharacter : ACharacter {
	char UnknownData_5E0[0x128]; // 0x5e0(0x128)
	struct ULookAtOffsetComponent* LookAtOffsetComponent; // 0x708(0x08)
	struct UAnimationDataStoreAsset* AnimationDataStoreAsset; // 0x710(0x08)
	struct UAthenaAnimationSittingDataAsset* SittingAnimationDataAssets; // 0x718(0x08)
	struct UAthenaCharacterMovementComponent* AthenaCharacterMovementComponent; // 0x720(0x08)
	struct UCollidableCharacterComponent* CollidableCharacterComponent; // 0x728(0x08)
	char Docker[0x90]; // 0x730(0x90)
	...
	char ObjectMessageDispatcher[0xa0]; // 0x7d8(0xa0)
	...
	char OnJumpedDelegate[0x10]; // 0x970(0x10)
	...
	char UnknownData_BC8[0x78]; // 0xbc8(0x78)
...
struct AShip : AActor {
	...
	char AchievementSailFullyIntoTheWind[0x08]; // 0x908(0x08)
	...
	struct TArray<struct UClass*> PlayerControlsInteractablesClasses; // 0xa48(0x10)
	char ShipDynamics[0xa0]; // 0xa58(0xa0)
	char PhysicsErrorCorrection[0x1c]; // 0xaf8(0x1c)
	char UnknownData_B14[0x4]; // 0xb14(0x04)
	struct UShipSinkingParametersDataAsset* AdventureSinkingData; // 0xb18(0x08)
	char BuoyancySampleMovement[0x68]; // 0xb20(0x68)
	char SurfacingBuoyancySampleMovement[0x68]; // 0xb88(0x68)
	bool AttachPlayersToShipWhenSurfacing; // 0xbf0(0x01)
	char UnknownData_BF1[0x3]; // 0xbf1(0x03)
	float SurfacingAttachDuration; // 0xbf4(0x04)
	char DivingBuoyancySampleMovement[0x68]; // 0xbf8(0x68)
	bool AttachPlayersToShipWhenDiving; // 0xc60(0x01)
	char UnknownData_C61[0x3]; // 0xc61(0x03)
	float DivingAttachDuration; // 0xc64(0x04)
	struct UShipNosediveBrake* NosediveBrake; // 0xc68(0x08)
	struct UShipRolloverCorrector* RolloverCorrector; // 0xc70(0x08)
	struct UBowSplashContainer* BowSplashContainer; // 0xc78(0x08)
	struct UBowSplashContainer* SurfacingBowSplashContainer; // 0xc80(0x08)
	struct UBowSplashContainer* DivingBowSplashContainer; // 0xc88(0x08)
	struct UShipResurfaceWetnessContainer* ShipResurfaceWetnessContainer; // 0xc90(0x08)
	bool DisableSailingBowSplashesWhenDiving; // 0xc98(0x01)
	char UnknownData_C99[0x7]; // 0xc99(0x07)
	struct ULocatorContainer* ShipLocators; // 0xca0(0x08)
	struct FVector LocalSailForceApplicationOffset; // 0xca8(0x0c)
	char UnknownData_CB4[0x4]; // 0xcb4(0x04)
	struct UCurveFloat* ShipSpeedToChoppinessScalarCurve; // 0xcb8(0x08)
	struct UCurveFloat* HullSubmergedValueRemapping; // 0xcc0(0x08)
	float FakeBuoyancyZOffsetScalarSpringAccel; // 0xcc8(0x04)
	float ResurfacingFinishedSubmergedHullPercentageThreshold; // 0xccc(0x04)
	float PositionSamplerTimeWindow; // 0xcd0(0x04)
	struct FName ClientConvexHullCollisionProfile; // 0xcd4(0x08)
	float EmpiricalMaxSpeedInMPS; // 0xcdc(0x04)
	...
	struct UScrambledIdentityProviderComponent* GuildIdentityProviderComponent; // 0xd28(0x08)
	char UnknownData_D30[0x108]; // 0xd30(0x108)
	bool PlayerControlsEnabled; // 0xe38(0x01)
	char UnknownData_E39[0x7]; // 0xe39(0x07)
	struct AGuildPlaque* GuildPlaque; // 0xe40(0x08)
	char SightingEncounterParams[0x0c]; // 0xe48(0x0c)
	char CloseProximityEncounterParams[0x0c]; // 0xe54(0x0c)
	char UnknownData_E60[0x10]; // 0xe60(0x10)
	struct UClass* ShipCategoryObject; // 0xe70(0x08)
	struct UClass* ShipSizeObject; // 0xe78(0x08)
	struct UClass* ShipTypeObject; // 0xe80(0x08)
	struct TArray<struct AActor*> DamageableChildActors; // 0xe88(0x10)
	struct UShipPartsDamageTrackerComponent* ShipPartsDamageTrackerComponent; // 0xe98(0x08)
	struct ACrewShipManifest* CrewShipManifest; // 0xea0(0x08)
	char ShipIdentity[0x28]; // 0xea8(0x28)
	bool IsInCaptainedCrew; // 0xed0(0x01)
	char UnknownData_ED1[0x6f]; // 0xed1(0x6f)
	struct UObject* HullDamage; // 0xf40(0x08)
	struct AVoyageProposalContainer* QuestTable; // 0xf48(0x08)
	struct USurfaceWaterComponent* DeckWater; // 0xf50(0x08)
	struct UWaterExposureComponent* WaterExposureComponent; // 0xf58(0x08)
	struct UShroudBreakerTrackerComponent* ShroudBreakerTrackerComponent; // 0xf60(0x08)
	struct UFlotsamItemSpawnComponent* FlotsamComponent; // 0xf68(0x08)
	char MovementTimeStamp[0x70]; // 0xf70(0x70)
	char UnknownData_FE0[0xc8]; // 0xfe0(0xc8)
	float StormStrainWeight; // 0x10a8(0x04)
	float WorldEdgeWeight; // 0x10ac(0x04)
	float TetherMassInertiaScaleWhenAnchored; // 0x10b0(0x04)
	char UnknownData_10B4[0x4]; // 0x10b4(0x04)
	char StormStrainDamage[0x28]; // 0x10b8(0x28)
	char WorldEdgeDamage[0x28]; // 0x10e0(0x28)
	char ScuttleDamage[0x28]; // 0x1108(0x28)
	struct FVector2D WorldEdgeDamageRange; // 0x1130(0x08)
	float ScuttleForceSinkTime; // 0x1138(0x04)
	char UnknownData_113C[0x4]; // 0x113c(0x04)
	struct UClass* ProxyClass; // 0x1140(0x08)
	struct UShipEntitlementProcessingPolicyDataAsset* ShipEntitlementProcessingPolicyDataAsset; // 0x1148(0x08)
	char UnknownData_1150[0x1]; // 0x1150(0x01)
	bool HasEverStartedSailing; // 0x1151(0x01)
	bool EmissaryFlagActive; // 0x1152(0x01)
	bool InTunnelOfTheDamned; // 0x1153(0x01)
	char SurfacingState; // 0x1154(0x01)
	char UnknownData_1155[0x3]; // 0x1155(0x03)
	double FinishedResurfacingTimeStamp; // 0x1158(0x08)
	bool Scuttled; // 0x1160(0x01)
	char UnknownData_1161[0x7]; // 0x1161(0x07)
	struct TArray<struct UMobileInstancedStaticMeshComponent*> InstancedMeshes; // 0x1168(0x10)
	struct UClass* ConstraintBudget; // 0x1178(0x08)
	char UnknownData_1180[0x6b0]; // 0x1180(0x6b0)
	float ScuttleTime; // 0x1830(0x04)
	char UnknownData_1834[0x8c]; // 0x1834(0x8c)
};
...
struct AShipInternalWater : AActor {
	...
	struct UDynamicFlowComponent* DynamicFlowComponent; // 0x508(0x08)
	int32_t WaterOcclusionVolumeShrinkMaterialId; // 0x510(0x04)
	struct FName WaterOcclusionVolumeShrinkPropertyName; // 0x514(0x08)
	char UnknownData_51C[0x4]; // 0x51c(0x04)
	struct UCurveFloat* WaterOcclusionZoneReductionCurve; // 0x520(0x08)
	struct TArray<int32_t> WaterMeshIndicesForTextures; // 0x528(0x10)
	struct TArray<int32_t> WaterOcclusionVolumeIndicesForDynamicMaterials; // 0x538(0x10)
	struct UMaterialInterface* DynamicMaterialToCreate; // 0x548(0x08)
	struct UCurveFloat* FoaminessCurve; // 0x550(0x08)
	float RippleSizeMin; // 0x558(0x04)
	float RippleSizeMax; // 0x55c(0x04)
	float RippleHeight; // 0x560(0x04)
	float SuperheatedWaterCoolingRatePerSecond; // 0x564(0x04)
	float TimeToIgnoreCoolingDueToSuperheating; // 0x568(0x04)
	char UnknownData_56C[0x4]; // 0x56c(0x04)
	char SuperheatedWaterStatusToApply[0x18]; // 0x570(0x18)
	char UnknownData_588[0x28]; // 0x588(0x28)
	struct TArray<struct AActor*> OverlappingActors; // 0x5b0(0x10)
	char UnknownData_5C0[0x90]; // 0x5c0(0x90)
};
